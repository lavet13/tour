...
export type UpdateTelegramChatIdsInput = {
  telegramChatIds: Array<Scalars['String']['input']>;
};
...
export type AuthenticateWithTelegramMutation = { __typename?: 'Mutation', authenticateWithTelegram: { __typename?: 'TelegramAuthPayload', isNewUser: boolean, accessToken: string, refreshToken: string, user: { __typename?: 'User', id: string, email: string, name: string, telegram?: { __typename?: 'TelegramUser', id: string, telegramId: any, firstName: string, lastName?: string | null, username?: string | null, photoUrl?: string | null, authDate: any } | null } } };
...
export type TelegramChatIdsQuery = { __typename?: 'Query', telegramChats: Array<{ __typename?: 'TelegramChat', id: string, chatId: string }> };
...
export type CreateBookingMutation = { __typename?: 'Mutation', createBooking: { __typename?: 'Booking', id: string, firstName: string, lastName: string, phoneNumber: string, travelDate: any, seatsCount: number, status: BookingStatus, createdAt: any, updatedAt: any, telegram: boolean, whatsapp: boolean } };
