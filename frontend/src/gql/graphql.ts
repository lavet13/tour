...
export type InfiniteBookingsQuery = { __typename?: 'Query', bookings: { __typename?: 'BookingsResponse', edges: Array<{ __typename?: 'Booking', id: string, firstName: string, lastName: string, phoneNumber: string, travelDate: any, seatsCount: number, telegram: boolean, whatsapp: boolean, status: BookingStatus, createdAt: any, updatedAt: any, route?: { __typename?: 'Route', id: string, arrivalCity?: { __typename?: 'City', name: string } | null, departureCity?: { __typename?: 'City', name: string } | null } | null }>, pageInfo: { __typename?: 'PageInfo', endCursor?: string | null, hasNextPage: boolean, startCursor?: string | null, hasPreviousPage: boolean } } };
