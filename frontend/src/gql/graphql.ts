...
export type GetSchedulesByRouteQuery = { __typename?: 'Query', schedulesByRoute: Array<{ __typename?: 'Schedule', id: string, startTime: any, endTime: any, isActive: boolean, createdAt: any, updatedAt: any }> };
