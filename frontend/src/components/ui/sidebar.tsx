...
>(({ className, onClick, ...props }, ref) => {
  ...
  return (
    <Tooltip delayDuration={700}>
      ...
      <TooltipContent align={state === 'collapsed' ? 'start' : 'center'}>
        {state === 'expanded' && 'Закрыть меню'}
        {state === 'collapsed' && 'Открыть меню'}
      </TooltipContent>
    </Tooltip>
  )
})
...
interface SidebarContentProps extends Omit<ScrollAreaProps, 'ref'> {
  className?: string;
}
